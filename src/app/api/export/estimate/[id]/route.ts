...
export async function GET(_request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const workbook = buildWorkbook(sheets, { title: estimate.name, company: user.companyName })
  return workbookResponse(workbook, `constructx-estimate-${estimate.name.replace(/\s+/g, '-')}.xlsx`)
}
