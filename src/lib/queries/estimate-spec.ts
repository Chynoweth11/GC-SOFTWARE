  ...
  const sheets: SheetSpec[] = [
    {
      ...
      columns: [
        ...
        { header: 'Length', key: 'length', format: 'quantity' },
        { header: 'Width', key: 'width', format: 'quantity' },
        { header: 'Depth', key: 'depth', format: 'quantity' },
        { header: 'Net qty', key: 'netQty', format: 'quantity' },
        { header: 'Waste %', key: 'wastePct', format: 'percent' },
        { header: 'Gross qty', key: 'grossQty', format: 'quantity' },
        { header: 'Labor class', key: 'laborClass', width: 14 },
        { header: 'Hrs / unit', key: 'laborHrsPerUnit', format: 'quantity' },
        { header: 'Rate', key: 'laborRate', format: 'money2' },
        { header: 'Labor hours', key: 'laborHours', format: 'hours', total: true },
        { header: 'Labor $', key: 'laborCost', format: 'money', total: true },
        { header: 'Machine', key: 'equipmentClass', width: 16 },
        { header: 'Machine hours', key: 'equipmentHours', format: 'hours', total: true },
    ...
    },
    {
      ...
      columns: [
        ...
        { header: 'Quantity', key: 'qty', format: 'quantity' },
