      ...
      ? [
          {
            ...
            columns: [
              ...
              { header: 'Quantity', key: 'quantity', format: 'quantity' as const },
              { header: 'Unit', key: 'uom', width: 10 },
              { header: 'Labor hours', key: 'laborHours', format: 'hours' as const, total: true },
      ...
      ? [
          {
            ...
            columns: [
              ...
              { header: 'Budget qty', key: 'budgetQty', format: 'quantity' as const, total: true },
              { header: 'Installed', key: 'installedToDate', format: 'quantity' as const, total: true },
              { header: '% installed', key: 'pctInstalled', format: 'percent' as const },
              { header: 'Budget hours', key: 'budgetHours', format: 'hours' as const, total: true },
              { header: 'Earned hours', key: 'earnedHours', format: 'hours' as const, total: true },
              { header: 'Actual hours', key: 'actualHours', format: 'hours' as const, total: true },
              { header: 'Productivity factor', key: 'productivityFactor', format: 'quantity' as const },
              { header: 'Forecast hours', key: 'forecastHoursAtCompletion', format: 'hours' as const, total: true },
      ...
      ? [
          {
            ...
            columns: [
              ...
              { header: 'Hours', key: 'hours', format: 'hours' as const, total: true },
